...
const SvgIconEditFeedback = (props) => (
  <svg width={40} height={40} xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <g fill="none" fillRule="evenodd">
      <circle fill="url(#icon-edit-feedback_svg__a)" cx={20} cy={20} r={20} />
      <path
...
export default SvgIconEditFeedback;
